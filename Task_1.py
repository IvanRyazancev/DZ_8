# Задача. Дополнить телефонный справочник возможностью изменения и 
...
# слова до второго, в котором каждые два соседних слова принадлежат 
# словарю и отличаются только в одной букве.
